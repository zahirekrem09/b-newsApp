...
// import {passwordStrength} from '../untils/passwordValidate';
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatable.View style={styles.footer} animation="fadeInUpBig">
        ...
        {/* <Text style={styles.text_footer}>Profil İmage</Text>
        <View style={styles.action}>
          <FontAwesome name="image" color="#05375a" size={22} />
          <TextInput
            placeholder="Profil İmage Url "
            style={styles.textInput}
            autoCapitalize="none"
            // textContentType="emailAddress"
            onChangeText={(val) => setData({...data, photoURL: val})}
          />
        </View> */}
        <View style={styles.button}>
          ...
          <TouchableOpacity
            ...
            <Text style={[styles.textSign, {color: '#7952B3'}]}> Sign In</Text>
          </TouchableOpacity>
        </View>
      </Animatable.View>
    </View>
